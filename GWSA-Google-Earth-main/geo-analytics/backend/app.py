...
def create_app():
    ...
    def health():
        return jsonify({
            ...
            "sql_sage_merge_enabled": Config.SQL_SAGE_MERGE_ENABLED,
            "sql_sage_cutover_date": Config.SQL_SAGE_CUTOVER_DATE,
            "sql_gl_combined_object": Config.SQL_GL_COMBINED_OBJECT,
            "sql_budget_vs_actual_object": Config.SQL_BUDGET_VS_ACTUAL_OBJECT,
            "sql_budget_vs_actual_split": Config.SQL_BUDGET_VS_ACTUAL_SPLIT,
            "sql_daily_revenue_budget_object": Config.SQL_DAILY_REVENUE_BUDGET_OBJECT,
