...
export default function DateRangePicker({
  dateRange,
  onChange,
  preset: activePreset = 'This Month',
  allowedPresets = null,
  showCustom = true,
}) {
  ...
  const visiblePresets = Array.isArray(allowedPresets) && allowedPresets.length > 0
    ? PRESETS.filter((p) => allowedPresets.includes(p.label))
    : PRESETS;
